...
// Claude (Anthropic) — from Simple Icons
...
// OpenClaw — custom terminal/claw icon
export function OpenClawIcon({ className, size = 24 }: IconProps) {
  return (
...
// Generic fallback
export function GenericAgentIcon({ className, size = 24 }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" width={size} height={size} className={className}>
      <path d="M12 8V4H8" />
...
export function getAgentIconComponent(type: AgentType): React.FC<IconProps> {
  switch (type) {
    case "ClaudeCode":
    case "ClaudeDesktop":
      return ClaudeIcon;
